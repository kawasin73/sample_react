...
export default React.createClass({
    ...
    render() {
        ...
        const command = todo.completed
            ? <a href="javascript:void(0)" onClick={this.activate}> activate </a>
            : <a href="javascript:void(0)" onClick={this.complete}> complete </a>;
    ...
    activate() {
        this.props.actions.activate(this.props.todo.id);
    },
    remove() {
